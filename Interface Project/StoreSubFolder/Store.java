...
public class Store {
    ...
    public static void createItems(){
        items.add(new Fashion(0, "The Himalayan Birkin", 500000l, 10));
        items.add(new Fashion(1, "Solid Gold OVO x Air Jordans", 2000000l, 20));
        items.add(new Fashion(2, "Gold Cartier Crash", 6000000l, 5));

        items.add(new RealEstate(3, "Kanye West's Former Wyoming Ranch", 20000000l, 1));
        items.add(new RealEstate(4, "20 Acre Plot of Land in a Rural Town in Indiana", 100000l, 50));
        items.add(new RealEstate(5, "40 Acre Plot w/  Farm in Oregon",2000000l, 50 ));

        items.add(new Misc(6, "The Persistence of Memory", 100000000l, 1));
        items.add(new Misc(7, "Apple Macbook Air",2000l, 100));
        items.add(new Misc(8, "Ream of Paper", 15l, 100));
        items.add(new Misc(9, "The Death of Marat", 500000000l, 1));
    }
